...
@InputType()
export class BaseCandidateInput {
  @Field(() => String, {
    nullable: true,
  })
  address!: string;
...
@InputType()
export class CreateCandidateInput extends BaseCandidateInput {}

@InputType()
export class UpdateCandidateInput extends BaseCandidateInput {
  @Field()
  id!: string;
}
...
@InputType()
export class CandidateQueryInput extends BaseQueryInput({
  conditionInput: CandidateConditionInput,
  paginationInput: CandidatePaginationInput,
})<CandidateConditionInput, CandidatePaginationInput> {}
