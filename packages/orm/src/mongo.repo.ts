...
import { IMongoAggregation, IMongoRequest, MongoBulkRequest, OrmSchema } from './models';
import {
  convertPopulate,
  DELETE_OPTIONS,
  preHandleBody,
...
export abstract class MongoRepo<T extends OrmSchema, ID = string> implements IMongoRepository<T, ID>, OnModuleInit {
