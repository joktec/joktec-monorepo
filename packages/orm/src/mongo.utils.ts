...
import { IMongoRequest, OrmSchema } from './models';
...
export const preHandleCondition = <T extends OrmSchema>(condition: any): ICondition<T> => {
...
export const preHandleQuery = <T extends OrmSchema>(
 ...
 * @param isSoftDelete
 */
export const convertPopulate = <T extends OrmSchema>(
