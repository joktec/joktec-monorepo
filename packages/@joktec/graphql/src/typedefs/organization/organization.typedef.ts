...
@ObjectType()
export class Organization extends BaseTypedef {
  @Field(() => String, {
    nullable: true,
  })
  address!: string;
...
@ObjectType()
export class OrganizationDetail extends Organization {}

@ObjectType()
export class OrganizationListReponse extends BaseListResponse({
